...
class NavigationInstance extends BaseInstance
{
	public function __construct(){
		parent::__construct(new Navigation);
	}
    ...
    public function getDefaultNavigation(){
        return Navigation::where('group_name', 'Default')->where('is_active', 1)->first();
    }


	public function name($group_name){
		$this->data = Navigation::where('group_name', $group_name)->first();
		return $this;
	}
